...
public class MainController {
        ...
        for (Expense expense : expenseList){
            ...
            if (expense.getDateTime() != null && !expense.getDateTime().isEmpty()) {
                try {
                    ...
                    expense.setDate(dt.toLocalDate().toString());
                    expense.setTime(dt.toLocalTime().toString());
                } catch (Exception e) {
                    expense.setDate("Invalid date");
                    expense.setTime("Invalid time");
                }
            } else {
                expense.setDate("No date");
                expense.setTime("No time");
            }
        }
    ...
    public String showUpdate(@RequestParam("expId") int id, Model model){
        ...
        expenseDTO.setCategory(expense.getCategory() != null ? expense.getCategory().getName() : "Unknown");
